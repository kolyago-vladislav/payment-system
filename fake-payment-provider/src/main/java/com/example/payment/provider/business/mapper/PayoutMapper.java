...
public abstract class PayoutMapper {
    ...
    public abstract Payout to(PayoutWriteDto dto);
    ...
    @Mapping(target = "createdAt", expression = "java(dateTimeUtil.to(payout.getCreatedAt()))")
    @Mapping(target = "updatedAt", expression = "java(dateTimeUtil.to(payout.getUpdatedAt()))")
    @Mapping(target = "merchantId", source = "merchant.id")
    @Mapping(target = "status", source = "status")
    @Mapping(target = "amount", source = "amount")
    @Mapping(target = "currency", source = "currency")
    @Mapping(target = "externalId", source = "externalId")
    public abstract PayoutDto from(Payout payout);
}
